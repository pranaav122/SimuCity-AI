...
class AgentNeeds(BaseModel):
    ...
    energy: float = Field(default=85.0, ge=0.0, le=100.0, description="100=Fully rested, 0=Exhausted")
    stress: float = Field(default=15.0, ge=0.0, le=100.0, description="0=Zen, 100=Burnout")
    social: float = Field(default=60.0, ge=0.0, le=100.0, description="100=Socially fulfilled, 0=Isolated")
    knowledge: float = Field(default=20.0, ge=0.0, le=100.0, description="Cumulative academic understanding")
